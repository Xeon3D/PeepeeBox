    ...
    switch (addr) {
        ...
        case 0x37:
            ...
            if (size == 1) {
                ...
                if ((addr == 0x34) && (MACHINE_IS(machine_at_cubx_init)))
...
acpi_reg_write_sis_5595(int size, uint16_t addr, uint8_t val, void *priv)
{
    ...
    switch (addr) {
        ...
        case 0x1c:
            ...
            if ((MACHINE_IS(machine_at_m747_init)) && (val & 0x10) &&
...
acpi_reset(void *priv)
{
    ...
    dev->regs.gpireg[0] = (MACHINE_IS(machine_at_m773_init)) ? 0xf5 : 0xff;
    ...
    if (dev->vendor == VEN_VIA_596B) {
        ...
        if ((MACHINE_IS(machine_at_ficva503a_init)) || (MACHINE_IS(machine_at_6via90ap_init)))
            dev->regs.gpi_val |= 0x00000004;
        else if ((MACHINE_IS(machine_at_ficka6130_init)))
         ...
         */
        else if (MACHINE_IS(machine_at_delhi3_init))
    ...
    if (MACHINE_IS(machine_at_tomahawk_init))
